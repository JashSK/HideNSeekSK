...
(function() {
    ...
    const musicArray = ['https://seanysean.github.io/sk-hs-assets/Dark_80s_Horror_Music_-_Intruder_Royalty_Free_No_Copyright.mp3'];
    let currentSong;
    let arrayOfTimeouts = [];
...
.seansimpossibletorememberclassname {
    ...
    .jashwideview {
        background: radial-gradient(RGBa(0, 245, 249, 0.4), RGBa(0, 245, 249, 0.4) 10%, #000 60%);
        background-position: 50% -10vh;
        width: 100%;
        border: none;
    }
